...
function Hero() {
  return (
      <div className=" bg-purple-500  p-40 pl-265 h-1/8  w-1440">
                      ...
                      <div className="self-stretch flex flex-row items-center justify-center text-left text-[0.75rem] font-copyright-text">
                          <div className="flex-1 flex flex-col py-[1.5rem] px-[1.44rem] items-center justify-start">
                              <a
                                  ...
                                  className="h-38 rounded-full  gap-8 self-stretch rounded-64 flex flex-row py-[0.75rem] px-[1.5rem] items-center justify-center  bg-black text-white font-bold">
                          ...
                          <div className="flex-1 flex flex-col py-[1.5rem] px-[1.44rem] items-center justify-start">
                              <a
                                  ...
                                  target="_blank" // Opens the link in a new tab
                                  rel="noopener noreferrer" // Recommended for security reasons when using target="_blank"
                                  className=" h-38 rounded-full gap-8 self-stretch rounded-64 flex flex-row py-[0.75rem] px-[1.5rem] items-center justify-center border- border-[2px] border-solid border-white text-white font-bold">
                                  Create a new project
                              </a>
                          </div>
                      </div>
